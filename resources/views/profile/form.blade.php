...
<div class="form-group {{ $errors->has('statusothers') ? 'has-error' : ''}}">
    <label for="statusothers" class="control-label">{{ 'Statusothers' }}</label>
    <input class="form-control" name="statusothers" type="text" id="statusothers" value="{{ isset($profile->statusothers) ? $profile->statusothers : ''}}" >
...
<div class="form-group {{ $errors->has('school') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="school" type="text" id="school" value="{{ isset($profile->school) ? $profile->school : ''}}" >
    {!! $errors->first('school', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('major') ? 'has-error' : ''}}">
    <label for="major" class="control-label">{{ 'Major' }}</label>
    <input class="form-control" name="major" type="text" id="major" value="{{ isset($profile->major) ? $profile->major : ''}}" >
...
<div class="form-group {{ $errors->has('district') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="district" type="text" id="district" value="{{ isset($profile->district) ? $profile->district : ''}}" >
...
<div class="form-group {{ $errors->has('subdistrict') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="subdistrict" type="text" id="subdistrict" value="{{ isset($profile->subdistrict) ? $profile->subdistrict : ''}}" >
...
<div class="form-group {{ $errors->has('postnumber') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="postnumber" type="text" id="postnumber" value="{{ isset($profile->postnumber) ? $profile->postnumber : ''}}" >
...
<div class="form-group {{ $errors->has('fax') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="fax" type="text" id="fax" value="{{ isset($profile->fax) ? $profile->fax : ''}}" >
    {!! $errors->first('fax', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('fileregister') ? 'has-error' : ''}}">
    <label for="fileregister" class="control-label">{{ 'Fileregister' }}</label>
    <input class="form-control" name="fileregister" type="file" id="fileregister" value="{{ isset($profile->fileregister) ? $profile->fileregister : ''}}" >
    {!! $errors->first('fileregister', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('bill_school') ? 'has-error' : ''}}">
    <label for="bill_school" class="control-label">{{ 'Bill School' }}</label>
    <input class="form-control" name="bill_school" type="text" id="bill_school" value="{{ isset($profile->bill_school) ? $profile->bill_school : ''}}" >
    {!! $errors->first('bill_school', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('bill_major') ? 'has-error' : ''}}">
    <label for="bill_major" class="control-label">{{ 'Bill Major' }}</label>
    <input class="form-control" name="bill_major" type="text" id="bill_major" value="{{ isset($profile->bill_major) ? $profile->bill_major : ''}}" >
...
<div class="form-group {{ $errors->has('bill_address') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="bill_address" type="text" id="bill_address" value="{{ isset($profile->bill_address) ? $profile->bill_address : ''}}" >
    {!! $errors->first('bill_address', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('bill_district') ? 'has-error' : ''}}">
    <label for="bill_district" class="control-label">{{ 'Bill District' }}</label>
    <input class="form-control" name="bill_district" type="text" id="bill_district" value="{{ isset($profile->bill_district) ? $profile->bill_district : ''}}" >
    {!! $errors->first('bill_district', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('bill_subdistrict') ? 'has-error' : ''}}">
    <label for="bill_subdistrict" class="control-label">{{ 'Bill Subdistrict' }}</label>
    <input class="form-control" name="bill_subdistrict" type="text" id="bill_subdistrict" value="{{ isset($profile->bill_subdistrict) ? $profile->bill_subdistrict : ''}}" >
    {!! $errors->first('bill_subdistrict', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('bill_postnumber') ? 'has-error' : ''}}">
    <label for="bill_postnumber" class="control-label">{{ 'Bill Postnumber' }}</label>
    <input class="form-control" name="bill_postnumber" type="text" id="bill_postnumber" value="{{ isset($profile->bill_postnumber) ? $profile->bill_postnumber : ''}}" >
    {!! $errors->first('bill_postnumber', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('bill_tel') ? 'has-error' : ''}}">
    <label for="bill_tel" class="control-label">{{ 'Bill Tel' }}</label>
    <input class="form-control" name="bill_tel" type="text" id="bill_tel" value="{{ isset($profile->bill_tel) ? $profile->bill_tel : ''}}" >
    {!! $errors->first('bill_tel', '<p class="help-block">:message</p>') !!}
</div>
<div class="form-group {{ $errors->has('bill_fax') ? 'has-error' : ''}}">
    <label for="bill_fax" class="control-label">{{ 'Bill Fax' }}</label>
    <input class="form-control" name="bill_fax" type="text" id="bill_fax" value="{{ isset($profile->bill_fax) ? $profile->bill_fax : ''}}" >
