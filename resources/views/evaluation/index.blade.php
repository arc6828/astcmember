            ...
            <div class="col-md-9">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="GET" action="{{ url('/evaluation') }}" accept-charset="UTF-8" class="form-inline my-2 my-lg-0 float-right" role="search">
                        ...
                        <div class="table-responsive">
                            ...
                            <div class="pagination-wrapper"> {!! $evaluation->appends(['search' => Request::get('search')])->render() !!} </div>
                        </div>
