...
<div class="form-group {{ $errors->has('filename') ? 'has-error' : ''}}">
    ...
    <input class="form-control d-none" name="title-word" type="text" value="Word{{ Auth::user()->profile == 'academic-admin' ? '-blind' : '' }}"  required="" readonly>
...
<div class="form-group {{ $errors->has('filename') ? 'has-error' : ''}}">
    ...
    <input class="form-control d-none" name="title-pdf" type="text" value="PDF{{ Auth::user()->profile == 'academic-admin' ? '-blind' : '' }}"  required=""  readonly>
